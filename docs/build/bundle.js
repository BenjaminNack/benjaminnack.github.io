...
var app = (function () {
    ...
    /* src/pages/Index.svelte generated by Svelte v3.30.1 */
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text(t3_value);
    			t4 = space();
    			attr_dev(h3, "class", "svelte-aicmt");
    			add_location(h3, file, 31, 12, 1084);
    			...
    			attr_dev(img, "class", "svelte-aicmt");
    			add_location(img, file, 33, 16, 1162);
    			attr_dev(div0, "class", "card-banner-crop svelte-aicmt");
    			add_location(div0, file, 32, 12, 1115);
    			attr_dev(p, "class", "svelte-aicmt");
    			add_location(p, file, 35, 12, 1261);
    			attr_dev(div1, "class", "card svelte-aicmt");
    			add_location(div1, file, 30, 8, 1053);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h11 = element("h1");
    			h11.textContent = "my name is Benjamin,";
    			t3 = space();
    			h12 = element("h1");
    			h12.textContent = "but you can call me Ben";
    			t5 = space();
    			h3 = element("h3");
    			h3.textContent = "I'm a self taught software developer.";
    			t7 = space();
    			p = element("p");
    			...
    			attr_dev(h10, "class", "svelte-aicmt");
    			add_location(h10, file, 20, 8, 747);
    			attr_dev(h11, "class", "svelte-aicmt");
    			add_location(h11, file, 21, 8, 768);
    			attr_dev(h12, "class", "svelte-aicmt");
    			add_location(h12, file, 22, 8, 806);
    			attr_dev(h3, "class", "svelte-aicmt");
    			add_location(h3, file, 23, 8, 847);
    			attr_dev(section, "class", "header-tags");
    			add_location(section, file, 19, 4, 709);
    			attr_dev(header, "class", "svelte-aicmt");
    			add_location(header, file, 18, 0, 696);
    			add_location(p, file, 27, 0, 920);
    			attr_dev(div, "class", "projects svelte-aicmt");
    			add_location(div, file, 28, 0, 956);
    		},
    ...
    /* src/Nav.svelte generated by Svelte v3.30.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*page*/ ctx[0] === 0 && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li, "class", "page-item svelte-ynrtup");
    			add_location(li, file$1, 8, 8, 126);
    			attr_dev(ul, "class", "page-list svelte-ynrtup");
    			add_location(ul, file$1, 7, 4, 95);
    			add_location(nav, file$1, 6, 0, 85);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
